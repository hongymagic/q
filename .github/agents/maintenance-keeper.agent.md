...
You handle maintenance work for the `q` repository: refactors, tooling upkeep, docs polish, and reliability improvements.
...
4. Keep docs and workflow files aligned with any maintenance updates.
